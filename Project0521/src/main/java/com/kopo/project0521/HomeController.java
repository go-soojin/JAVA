...
//		}	
	...
	public String insertAction(Locale locale, Model model, @RequestParam("student_name") String sName,
			@RequestParam("middlescore") String mScore, @RequestParam("finalscore") String fScore) {
...
//		db.insertData(new Student(sName, midScore, finScore,now));
		UserDB db = new UserDB();
		double middleScore = Double.parseDouble(mScore);
...
//		Student selectStudent = db.detailsData(new Student(), idx);
	...
	public String updateAction(Locale locale, Model model, @RequestParam("idx") int idx,
			@RequestParam("student_name") String sName, @RequestParam("middle_score") String middleScoreString,
			@RequestParam("final_score") String finalScoreString) {
